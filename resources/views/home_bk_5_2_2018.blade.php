            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="height: 100%">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img async src="/public/images/slide.jpg" alt="#" />
                    </div>
                    <div class="item">
                        <img async src="/public/images/slide1.jpg" alt="#" />
                    </div>
                    <div class="item">
                        <img async src="/public/images/slide2.jpg" alt="#" />
                    </div>
                    <div class="item">
                        <img async src="/public/images/slide3.jpg" alt="#" />
                    </div>
                </div>
<div id="searchhome">
				<div class="position">
