	...
	<div class="mask">
		<div class="position">
			<ul class="breadcrumbs">
				...
				<li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
					<a href="/danh-sach/" itemprop="url"><span itemprop="title">Nhà thuốc</span></a>
				</li>
			...
			<% for (var i = 0; i < obj.length; i++) { %>
				<li>
					<a href="#tab-<%= obj[i].name %>" class="has-icon icon-<%= obj[i].name %>"
						...
						title="Lọc danh sách nhà thuốc theo <%= obj[i].displayName %> - danh sách các tùy chọn">
						<%= obj[i].displayName %>
					</a>
				</li>
			<% } %>
	...
	<div class="has-account-type-selector">
		...
		<div class="tab-content-container">
			...
			<div id="login-tab" class="tab-content">
				...
				<form method="post" action="https://vicare.vn/dang-nhap/?next=/danh-sach-nha-thuoc" name="login">
					<div class="form-row">
						<div class="form-field">
							<label>
								Email:
			...
			<div id="signup-tab" class="tab-content active">
				...
				<div class="instruction">
					...
					<div class="for-source-register_place">
						...
						<p>
							Bạn cần chọn loại tài khoản là "Quản lý nhà thuốc".
						</p>
					</div>
					...
					<div class="for-source-favourite">
						<p>
							Sau khi mở tài khoản, bạn có thể lưu lại nhà thuốc và bác sĩ đáng quan tâm, cũng như sử dụng đầy đủ các chức năng, dịch vụ của ViCare
						</p>
					</div>
						...
						<div class="form-field">
							...
							<div class="form-field-input">
								<select class="account-type-selector" name="type">
									...
									<option value="place">Nhà thuốc &amp; doanh nghiệp</option>
								</select>
							</div>
						</div>
					</div>
