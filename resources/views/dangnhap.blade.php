...
<div id="login" class="has-switch-content  all-others">	
	<div class="position">
		<div class="content">
			<h1><i class="fa fa-user" aria-hidden="true"></i> Đăng nhập vào BacsiViet</h1>
...
<div class="signup-intro">
	...
	<div class="for-other">
		...
		<p>
			Bạn chưa có tài khoản? <a href="{{url('dang-ky')}}">Mở tài khoản BacsiViet cực nhanh tại đây</a>.
		</p>
	</div>
</div>
		...
		<div class="button-row">
			<a href="{{ url('/facebook') }}">
				<button type="button" name="facebook">
					<i class="fa fa-facebook" aria-hidden="true"></i> Đăng nhập qua Facebook
				</button>
			</a>
			<a href="{{ url('/redirect/google') }}">
				<button type="button" name="facebook">
					<i class="fa fa-google-plus" aria-hidden="true"></i> Đăng nhập qua Google
				</button>
			</a>
		</div>		
