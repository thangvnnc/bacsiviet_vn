@extends('v2/structor/main',['title'=> 'Tin tức'])
@section('content')
 <?php
    ...
    <div class="top-new">          
	    <div class="latest-post">
	         ...
	         <div class="latest-post-image">
	                ...
	                <a href="/baiviet/{{$baiviet_new->article_url}}-{{$baiviet_new->article_id}}" class="image-title image img"  @if(!empty($baiviet_new->image)) style="margin-left: 0px;
                            width: 100%;
                            height: 100%;
                            display: block;
	        ...
	        <div class="latest-post-body">
	            <h2 class="title-latest-post">
	                ...
	                <a href="/baiviet/{{$baiviet_new->article_url}}-{{$baiviet_new->article_id}}" title="{!! $baiviet_new['article_title']!!}">
                    ...
                    <?php $art = App\Article::whereIn('catalog_id',$catesID)->orWhere('catalog_id',$item['id'])->orderBy('created_at','DESC')->take(6)->get(); ?>
                     ...
                     @foreach ($art as $ar)
                         ...
                         <?php $tieude=to_slug($ar['article_title']); ?>
                            <li>
                                <h4>
                                    <a href="/baiviet/{{$ar->article_url}}-{{$ar->article_id}}" class="title">{{$ar['article_title']}}</a>
                                </h4>

                                <div class="body-post">
                                    <a href="/baiviet/{{$ar->article_url}}-{{$ar->article_id}}" class="image">
