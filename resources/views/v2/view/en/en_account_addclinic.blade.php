@extends('v2/view/en/en_account',['title'=> 'Add clinic'])
@section('en_account_content')
<div class="content-tk-home">
<div class="cnt-tk-add-csyt">
	<h1 class="h1-tk-addcsyt">Thêm phòng khám</h1>
	<form class=" form-horizontal" action=" " method="post"  id="contact_form" enctype="multipart/form-data">
		<div class="form-group">
			...
			<div class=" inputGroupContainer">
				<div class="">
					<input  name="clinicname" placeholder="Tên phòng khám" class="form-control"  type="text">
				</div>
			</div>
		</div>
