                        ...
                        <div class="answer1">
                                <div class="answer-t">
                                        ...
                                        <h3>
                                                ...
                                                <a href="@if($ans->user->doctor!=null || $ans->user->clinic!=null)@if($ans->user->doctor!=null)/en/danh-sach-bac-si-chi-tiet/@else/en/phongkham-chitiet/@endif{{App\Deals::strtoUrl($ans->user->doctor!=null?$ans->user->doctor->doctor_name: $ans->user->clinic->clinic_name)}}-{{$ans->user->doctor!=null?$ans->user->doctor->doctor_id: $ans->user->clinic->clinic_id}}@endif">
