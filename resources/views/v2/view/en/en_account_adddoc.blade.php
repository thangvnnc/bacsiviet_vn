@extends('v2/view/en/en_account',['title'=> 'Add doctor'])
                ...
                <form class=" form-horizontal" action=" " method="post" id="contact_form" enctype="multipart/form-data">
                    ...
                    <div class="form-group ">
                        ...
                        <div class=" inputGroupContainer">
                            <div class="">
                                <input name="doctorname" placeholder="Họ và tên bác sĩ" class="form-control" type="text">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class=" inputGroupContainer">
                            <div class="">
                                ...
                                <textarea name="description" placeholder="Describe" class="form-control"
                                          type="text"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class=" inputGroupContainer">
                            <div class="">
                                ...
                                <input name="kinhnghiem" placeholder="" class="form-control"
                    ...
                    <div class="form-group ">
                        ...
                        <div class=" inputGroupContainer">
                            <div class="">
                                ...
                                <input name="daotao" placeholder="" class="form-control"
                                       type="text" data-role="tagsinput">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class=" inputGroupContainer">
                            <div class="">
                                <input name="doctortimework" placeholder="Timework" class="form-control"
                                       type="text">
                            </div>
                        </div>
                    </div>
